/*******************************************************************************
* File Name          : SDCardDefines.h
* Author             : John P Condon
* Version            : V 1.0
* Date               : 5/23/2011
* Description        : Contains definitions for SD Card IO
*******************************************************************************/
#ifndef __SDCARD_DEFINES_H__
#define __SDCARD_DEFINES_H__
...
enum SDTransferState{
        SD_TRANSFER_OK 		= 0,
				SD_TRANSFER_BUSY 	= 1,
				SD_TRANSFER_ERROR = (uint32_t)(0x0FF),
};
